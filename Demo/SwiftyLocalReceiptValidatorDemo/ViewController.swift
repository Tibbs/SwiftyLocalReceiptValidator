...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let receiptUrl = Bundle.main.appStoreReceiptURL {
            ...
            print("Local Receipt Exist")

        }
        

       // let receiptFound = try! ReceiptLoader.init().loadReceipt()
    ...
    func verifyReceipt(completion: @escaping (VerifyReceiptResult) -> Void) {
        ...
        case .success(let receipt):
            ...
            //SwiftyStoreKit.verifyReceipt(using: receiptValidator , completion: completion)
            self.purchased()
    ...
    func purchased() {
        let appleValidator = AppleReceiptValidator(service: .production, sharedSecret: "ad86787d84914dd18656047dd1ea2d5c")
        SwiftyStoreKit.verifyReceipt(using: appleValidator) { result in
            switch result {
            case .success(let receipt):
                let productId = "com.vinnov.LivingWeatherHDfree.removeads"
